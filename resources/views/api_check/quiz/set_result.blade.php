...
@section('content')
  ...
  <form class="row" action="{!! url('/api/set_result') !!}" style="padding-top: 50px;">
    ...
    <div class="col-sm-offset-3 col-sm-6">
      ...
      <div class="form-group ">
        ...
        {!! Form::text('start_time', '2020/5/5 10:08:16', ['class' => 'form-control']) !!}
      </div>
      <div class="form-group ">
        {!! Form::label('end_time', 'Time:') !!}
        {!! Form::text('end_time', '2020/5/5 10:28:16', ['class' => 'form-control']) !!}
      </div>
      <div class="form-group ">
        {!! Form::label('score', 'Score:') !!}
        {!! Form::number('score', '10.22', ['class' => 'form-control']) !!}
      </div>
