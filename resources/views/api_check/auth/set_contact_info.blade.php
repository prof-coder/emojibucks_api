...
@section('content')
  ...
  <form class="row" action="{!! url('/api/auths/set_contact_info') !!}" style="padding-top: 50px;">

    <div class="col-sm-12 text-center">
      <h4>
        <strong>URL: </strong>
        {!! url('/api/auths/set_contact_info') !!}
      </h4>
      <br>
      <br>
    </div>
    ...
    <div class="col-sm-offset-3 col-sm-6">
      ...
      <div class="form-group ">
        ...
        {!! Form::text('email', 'hyuk@pan.com', ['class' => 'form-control']) !!}
      </div>
      <div class="form-group ">
        {!! Form::label('message', 'Message:') !!}
        {!! Form::text('message', 'Here is a dammy message', ['class' => 'form-control']) !!}
      </div>
